...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const book = {'@context':'https://schema.org','@type':'Book','name':'The Sovereign Brand: The AI Marketing Playbook for the Ambitious Professional','author':{'@type':'Person','name':'Siddharth Bhattacharjee'},'bookFormat':'https://schema.org/Book','url':'https://www.amazon.in/Sovereign-Brand-Marketing-Ambitious-Professional-ebook/dp/B0H1CPMBLN'};

...
export const metadata: Metadata = {
  ...
  verification: { google: 'icSOgF7PEnrS5H5keu90qy5ZE0Ry9dlNaaXVmucSvuA', other: { 'msvalidate.01': '814315011543B02D103BCE939C93899E' } },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return <html lang="en"><body><Header />{children}<div className="site-foot"><Footer /></div><Analytics /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(person) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(book) }} /></body></html>;
}
